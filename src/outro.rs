...
fn exit(mut commands: Commands, camera: Single<Entity, With<CameraTransition>>) {
    commands
        .entity(*camera)
...
//         .add_sub_state::<Outro>()
//         .add_systems(OnEnter(Outro::Fade), fade)
//         .add_systems(OnEnter(Outro::MouseControls), mouse_controls)
//         .add_systems(OnEnter(Outro::Mouse), mouse)
//         .add_systems(
//             Update,
//             update_mouse
//                 .before(AnimationSystems::Interpolate)
//                 .run_if(in_state(Outro::Mouse)),
//         )
//         .add_systems(OnEnter(Outro::MoveControls), move_controls)
//         .add_systems(OnEnter(Outro::Move), move_state)
//         .add_systems(OnEnter(Outro::FlavorText), flavor_text);
// }
//
...
// struct Music;
//
// fn fade(mut commands: Commands, fractal: Single<Entity, With<Fractal>>, assets: Res<OutroAssets>) {
//     let dur = 2.5;
//     commands.spawn((
//         Music,
...
//             if !input.is_empty() {
//                 commands.set_state(Outro::Mouse);
//                 true
//             } else {
//                 false
//             }
